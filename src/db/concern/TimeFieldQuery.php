...
trait TimeFieldQuery
{
     ...
     * @return $this
     */
    public function whereTimeInterval($field, $start, $interval = 'day', $step = 1, $logic = 'AND')
    {
     ...
     * @return $this
     */
    public function whereMonth($field, $month = 'this month', $step = 1, $logic = 'AND')
    {
     ...
     * @return $this
     */
    public function whereWeek($field, $week = 'this week', $step = 1, $logic = 'AND')
    {
     ...
     * @return $this
     */
    public function whereYear($field, $year = 'this year', $step = 1, $logic = 'AND')
    {
     ...
     * @return $this
     */
    public function whereDay($field, $day = 'today', $step = 1, $logic = 'AND')
    {
     ...
     * @return $this
     */
    public function whereBetweenTime($field, $startTime, $endTime, $logic = 'AND')
    {
     ...
     * @return $this
     */
    public function whereNotBetweenTime($field, $startTime, $endTime)
    {
        return $this->whereTime($field, '<', $startTime)->whereTime($field, '>', $endTime);
    }
    /**
