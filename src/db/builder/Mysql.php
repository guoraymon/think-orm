...
class Mysql extends Builder
{
     ...
     * @return string
     */
    protected function parseFindInSet(Query $query, $key, $exp, $value, $field)
    {
        if ($value instanceof Raw) {
            $value = $value->getValue();
        }
